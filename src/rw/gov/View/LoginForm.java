...
//    }
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if (username.isEmpty()) {
            ...
            account.setAccount_nbr(accountNumber);

            AccountDao dao = new AccountDao();
            Account retrievedAccount = dao.SearchForDeposit(accountNumber);

            if (retrievedAccount != null && retrievedAccount.getFirst_name() != null) {
