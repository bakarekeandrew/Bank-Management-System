    ...
    private void depositTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositTextActionPerformed
        // TODO add your handling code here:
         try {
            ...
            Double newTransaction = Double.parseDouble(amount1.getText());
            

            Account account = new Account();
            account.setAccount_nbr(id);
            account.setAmount(newAmount);

            AccountDao dao = new AccountDao();
            dao.depositAmount(account);

            Transaction transaction = new Transaction();
            transaction.setType("Dr");
            transaction.setAmount(newTransaction);
            transaction.setTimestamp(new Date());
            
            int accountNumber = Integer.parseInt(userText.getText());

            dao.saveTransaction(transaction, accountNumber);
